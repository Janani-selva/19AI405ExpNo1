...
```
## OUTPUT:
<img width="840" height="517" alt="WhatsApp Image 2026-07-22 at 4 06 48 PM" src="https://github.com/user-attachments/assets/87d86ccc-185e-4f70-b129-1651b8628e84" />

## RESULT:
 The PEAS description was successfully identified, and an intelligent AI agent was developed to perceive its environment, make rational decisions, and perform suitable actions to achieve the desired goal.
